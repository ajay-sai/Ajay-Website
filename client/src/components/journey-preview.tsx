...
const journeyHighlights = [
  {
    ...
    company: "AT&T – AI Foundry, Framework Team",
    ...
    keyMetric: "Agentic AI at scale",
    metricValue: 0,
    metricUnit: "text",
    highlights: ["LangGraph", "Multi-Agent Systems", "Agentic RAG", "Azure AI"],
    achievements: ["AI Foundry Framework", "All AT&T Agentic Apps", "Principal Engineer"],
  },
  {
    year: "2025",
