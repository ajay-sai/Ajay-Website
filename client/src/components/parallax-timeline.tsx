...
const timelineEvents: TimelineEvent[] = [
  {
    ...
    workplaceImages: [],
    achievements: [
      "Architected ABS.ai, AT&T's agentic AI platform for automated ticket resolution across <strong class='text-blue-400'>5+ business units</strong>, designing a 7-stage LangGraph orchestration engine with RAG and mainframe integration.",
      "Achieved <strong class='text-blue-400'>92%+ retrieval precision</strong> across all agent stages by engineering a pgvector-based RAG pipeline with cross-encoder reranking and memory-plan caching to reduce redundant LLM calls.",
      "Built <strong class='text-blue-400'>10+ FastAPI microservices</strong> with zero cross-service coupling by creating a production monorepo, 4-layer dependency architecture, and dynamic tool discovery at startup.",
      "Reduced regressions by implementing <strong class='text-blue-400'>15+ evaluators</strong> across 7 pipeline stages, combining LLM-as-judge and deterministic checks with LangSmith observability, CI-gated assertions, and dataset-driven eval suites.",
      "Maintained <strong class='text-blue-400'>zero unauthorized mainframe mutations</strong> through human-in-the-loop approval workflows covering 100% of sensitive AERO operations.",
      "Led AT&T agentic AI delivery across <strong class='text-blue-400'>5+ product lines and 6+ engineers</strong>, setting architecture standards, driving code reviews, and executing SAFe/Agile PI planning.",
      "Designed a PostgreSQL + pgvector data layer spanning <strong class='text-blue-400'>24+ tables</strong> with audit trails, JSONB, full-text search, staleness protection, and referential integrity.",
      "Achieved <strong class='text-blue-400'>100% end-to-end trace coverage</strong> and enabled zero-downtime schema evolution across 10+ services through centralized LLM invocation, structured logging, versioned state contracts, and backward-compatible migrations.",
      "Secured multi-tenant operations with <strong class='text-blue-400'>3-tier RBAC</strong>, category-level permissions, audit logging, and AT&T SSO integration.",
