...
const homeDepotImage1 =
  "/attached_assets/20250515_110951(0) (1)_1756775594777.jpg";
...
const dataScientistImage1 =
  "/attached_assets/20240427_120651_1756788379977.jpg";
const dataScientistImage2 =
  "/attached_assets/IMG_20180811_194748_1756789697281.jpg";
const dataScientistImage3 =
  "/attached_assets/IMG-20191110-WA0025_1756789697282.jpg";
const dataScientistImage4 =
  "/attached_assets/Screenshot_20180831-101808__01_1756789720602.jpg";

// Marketing Analyst images
const marketingAnalystImage1 =
  "/attached_assets/20210521_131718_1756788953660.jpg";
const marketingAnalystImage2 =
  "/attached_assets/IMG_20190509_180536_1756789644236.jpg";
const marketingAnalystImage3 =
  "/attached_assets/IMG-20190908-WA0038_1756789644237.jpg";
...
const bachelorImage3 =
  "/attached_assets/Screenshot_20181124-163448__01_1756789364618.jpg";

// High school education image
const highSchoolImage1 =
  "/attached_assets/IMG_20160620_123802_1756789570118.jpg";
...
const seniorDataScientistImage1 =
  "/attached_assets/20241025_152323_1756776021189.jpg"; // Was image 2
const seniorDataScientistImage2 =
  "/attached_assets/20240508_203952_1756776021190.jpg"; // Was image 1
const seniorDataScientistImage3 =
  "/attached_assets/20231215_095639_1756775804398.jpg"; // Was image 4

// Senior Data Analyst workplace images (added third image)
const seniorDataAnalystImage1 =
  "/attached_assets/IMG-20220807-WA0018_1756776767995.jpg";
const seniorDataAnalystImage2 =
  "/attached_assets/20220805_214208_1756776778383.jpg";
const seniorDataAnalystImage3 = "/attached_assets/IMG_1219_1756777552748.jpg"; // New image

// Graduate Assistant workplace images
const graduateAssistantImage1 =
  "/attached_assets/20240424_161717_1756780061878.jpg";
const graduateAssistantImage2 =
  "/attached_assets/Screenshot_20190129-080233_1756780061880.jpg";
const graduateAssistantImage3 =
  "/attached_assets/Generated Image September 01, 2025 - 10_25PM (1)_1756780361828.jpeg";
...
const bridgeSolutionsImage1 =
  "/attached_assets/IMG_20170820_163622_1756780825081.jpg";
const bridgeSolutionsImage2 =
  "/attached_assets/IMG-20170814-WA0017_1756780825082.jpg";
const bridgeSolutionsImage3 =
  "/attached_assets/IMG-20170814-WA0013_1756780825082.jpg";
const bridgeSolutionsImage4 =
  "/attached_assets/IMG-20170811-WA0004_1756789814799.jpg";
...
const timelineEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    companyColor: "#e91e63",
    workplaceImages: [
      marketingAnalystImage1,
      marketingAnalystImage2,
      marketingAnalystImage3,
    ],
    achievements: [
  ...
  },
  {
    ...
    companyColor: "#d32f2f",
    workplaceImages: [
      graduateAssistantImage1,
      graduateAssistantImage2,
      graduateAssistantImage3,
    ],
    achievements: [
  ...
  },
  {
    ...
    companyColor: "#00796b",
    workplaceImages: [
      bridgeSolutionsImage3,
      bridgeSolutionsImage2,
      bridgeSolutionsImage1,
      bridgeSolutionsImage4,
    ],
    achievements: [
...
export default function ParallaxTimeline() {
  ...
  const [manualImageIndices, setManualImageIndices] = useState<{
    [key: number]: number;
  }>({});
  ...
  const startAutoScroll = () => {
    ...
    const smoothScroll = (currentTime: number) => {
      ...
      const currentScrollY =
        startScrollY + (targetScrollY - startScrollY) * progress;
    ...
    const handleScroll = () => {
      ...
      if (!ticking) {
        requestAnimationFrame(() => {
          ...
          const clampedEvent = Math.max(
            0,
            Math.min(totalEvents - 1, activeIndex),
          );
        ...
        <div className="relative">
          ...
          {timelineEvents.map((event, index) => {
            ...
            const itemProgress = Math.max(
              ...
              Math.min(
                1,
                (scrollProgress - index / timelineEvents.length) *
              ...
              >
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 top-8 md:top-8 sm:top-12 z-20">
                  {event.description.includes("Harley Davidson") ? (
                    ...
                    <div
                      className={`w-16 h-16 md:w-20 md:h-20 rounded-full bg-white flex items-center justify-center border-4 border-background transition-all duration-500 shadow-lg overflow-hidden ${
                    ...
                    >
                      <img
                        src={
                          event.title.includes("Lead Data Scientist")
                            ? homeDepotStoreLogo
                            : homeDepotMainLogo
                        }
                        alt="Home Depot Logo"
                  ...
                  ) : event.description.includes("Anahata") ||
                    event.title.includes("Anahata") ? (
                    ...
                    <div
                      className={`w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-r ${event.color} flex items-center justify-center border-4 border-background transition-all duration-500 ${
                        isActive
                ...
                >
                  ...
                  <div className="w-full lg:flex-1 lg:max-w-2xl">
                    <div
                      className="quantum-card p-6 rounded-xl shadow-lg overflow-hidden"
                      style={{
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2 mb-3">
                        <span
                          className={`inline-block px-3 py-1 rounded-full text-sm font-bold bg-gradient-to-r ${event.color} text-white shadow-sm`}
                        >
                          {event.year}
                        </span>
                        <span
                          className={`inline-block px-3 py-1 rounded-full text-xs font-medium border ${isActive ? "border-primary/50 bg-primary/10 text-primary" : "border-border bg-secondary/50 text-muted-foreground"} transition-all duration-300`}
                        >
                          📅 {event.dateRange}
                        </span>
                      </div>
                        ...
                        {event.achievements.map(
                          (achievement, achievementIndex) => {
                            ...
                            return (
                              ...
                              >
                                <div
                                  className={`flex-shrink-0 w-5 h-5 rounded-full bg-gradient-to-r ${event.color} flex items-center justify-center mt-0.5 shadow-sm`}
                                >
                  ...
                  <div className="w-full lg:flex-1 lg:max-w-sm">
                    ...
                    event.workplaceImages.length > 0 ? (
                          ...
                          {event.workplaceImages
                            ...
                            .map((image, imageIndex) => {
                              ...
                              if (manualIndex !== undefined) {
                                ...
                                const cycleProgress =
                                  offsetProgress % (imageCount * 3); // Much slower cycling
                                currentImageIndex =
                                  Math.floor(cycleProgress / 3) % imageCount;
                              }
        ...
        {isInJourneySection && (
          <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50">
            <div className="flex items-center space-x-3 bg-background/90 dark:bg-background/80 backdrop-blur-lg rounded-full px-6 py-3 border border-border shadow-2xl">
              ...
              <span className="text-foreground font-bold text-sm min-w-[3rem] text-center">
