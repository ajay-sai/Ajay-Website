...
export default function Portfolio() {
  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* Footer */}
      <footer className="relative z-10 py-12 bg-neural-primary border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="text-2xl font-bold gradient-text mb-4">Ajay Miryala</div>
            <p className="text-muted-foreground mb-6">Lead Data Scientist | Machine Learning Engineer | AI Innovator</p>
            ...
            <div className="text-sm text-muted-foreground">
              © 2024 Ajay Miryala. Built with quantum-enhanced web technologies.
            </div>
          </div>
        </div>
      </footer>
